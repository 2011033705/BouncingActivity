...
public class Main : SEScene
{
    ...
    {
        base.initialize(rsc);
        rsc.prepare_font("myfont", "courier new bold underline color=#FF6600",60);
        
        bg = add_sprite_for_color(Color.instance("#FFFF00"), get_scene_width(), get_scene_height());
        bg.move(0,0);
		...
		rsc.prepare_image("myimage","troll", get_scene_width()*0.1);
